  ...
  <BaseModal :name="this.name" header="Add Comment" >
    <div class="p-m-1 p-grid p-fluid p-formgrid p-grid">
      <div class="p-field p-col">
        <Textarea v-model="newComment" :autoResize="true" rows="5" cols="30" placeholder="Add a comment..."/>
        <Dropdown v-model="newComment" :options="suggestedComments" :showClear="true"
