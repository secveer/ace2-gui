...
"""
NOTE: There are no tests for the foreign key constraints, namely deleting a NodeThreat that is tied to a Node. The
DELETE endpoint will need to be updated once the Node endpoints are in place in order to account for this.
"""
