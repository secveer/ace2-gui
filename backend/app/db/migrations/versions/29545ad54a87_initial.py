...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_analysis_module_type_value"),
        "analysis_module_type",
        ["value"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_event_prevention_tool_value"),
        "event_prevention_tool",
        ["value"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_node_history_action_value"),
        "node_history_action",
        ["value"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["analysis_module_type.uuid"],
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["observable_type_uuid"],
            ["observable_type.uuid"],
        ),
        sa.PrimaryKeyConstraint("analysis_module_type_uuid", "observable_type_uuid"),
    )
    op.create_index(
        op.f("ix_analysis_module_type_observable_type_mapping_analysis_module_type_uuid"),
        "analysis_module_type_observable_type_mapping",
        ["analysis_module_type_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_node_threat_node_threat_type_mapping_node_threat_uuid"),
        "node_threat_node_threat_type_mapping",
        ["node_threat_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_node_directive_mapping_node_uuid"),
        "node_directive_mapping",
        ["node_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_node_tag_mapping_node_uuid"),
        "node_tag_mapping",
        ["node_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_node_threat_mapping_node_uuid"),
        "node_threat_mapping",
        ["node_uuid"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["disposition_user_uuid"],
            ["user.uuid"],
        ),
        sa.ForeignKeyConstraint(
            ["disposition_uuid"],
            ["alert_disposition.uuid"],
        ),
        sa.ForeignKeyConstraint(
            ["event_uuid"],
            ["event.uuid"],
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["event_prevention_tool.uuid"],
        ),
        sa.PrimaryKeyConstraint("event_uuid", "prevention_tool_uuid"),
    )
    op.create_index(
        op.f("ix_event_prevention_tool_mapping_event_uuid"),
        "event_prevention_tool_mapping",
        ["event_uuid"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["remediation_uuid"],
            ["event_remediation.uuid"],
        ),
        sa.PrimaryKeyConstraint("event_uuid", "remediation_uuid"),
    )
    op.create_index(
        op.f("ix_event_remediation_mapping_event_uuid"),
        "event_remediation_mapping",
        ["event_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_event_vector_mapping_event_uuid"),
        "event_vector_mapping",
        ["event_uuid"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_role_mapping_user_uuid"),
        "user_role_mapping",
        ["user_uuid"],
        unique=False,
    )
    op.create_table(
        "node_history_feedback",
        sa.Column(
            "uuid",
            postgresql.UUID(as_uuid=True),
            server_default=sa.text("gen_random_uuid()"),
    ...
    op.create_index(
        op.f("ix_analysis_observable_instance_mapping_analysis_uuid"),
        "analysis_observable_instance_mapping",
        ["analysis_uuid"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_analysis_observable_instance_mapping_analysis_uuid"),
        table_name="analysis_observable_instance_mapping",
    )
    ...
    op.drop_index(
        op.f("ix_event_remediation_mapping_event_uuid"),
        table_name="event_remediation_mapping",
    )
    op.drop_table("event_remediation_mapping")
    op.drop_index(
        op.f("ix_event_prevention_tool_mapping_event_uuid"),
        table_name="event_prevention_tool_mapping",
    )
    ...
    op.drop_index(
        op.f("ix_node_threat_node_threat_type_mapping_node_threat_uuid"),
        table_name="node_threat_node_threat_type_mapping",
    )
    op.drop_table("node_threat_node_threat_type_mapping")
    op.drop_table("node")
    op.drop_index(
        op.f("ix_analysis_module_type_observable_type_mapping_analysis_module_type_uuid"),
        table_name="analysis_module_type_observable_type_mapping",
    )
