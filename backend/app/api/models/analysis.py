...
class Analysis(Node):
    ...
    analysis_module_type: AnalysisModuleType = Field(description="The analysis module type that was used to perform this analysis")
    ...
    event_summary: Optional[AnalysisEventSummary] = Field(description="Optional summary information to display on an event page if this analysis is ever added to an event")

    module_extended_version: Optional[str] = Field(description="An optional extended version of the analysis module that performed this analysis")

    module_version: str = Field(description="The version of the analysis module that performed this analysis")

    observables: Optional[List[ObservableInstance]] = Field(description="An optional list of observables discovered while performing this analysis")
